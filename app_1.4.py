...
def build_downloadable_report(customer, go_live_date, first_plan, plans, figures, branding,include_logo=True,):
    ...
    <td style="width:33%;text-align:center;border-top:2px solid {colors['teal']};padding-top:10px;">
      <div style="color:{colors['muted']};font-size:11px;font-weight:700;letter-spacing:0;text-transform:uppercase;">Production go-live</div>
      <div style="color:{colors['navy']};font-size:16px;font-weight:700;line-height:1.25;margin-top:5px;white-space:nowrap;">{go_live_date.strftime("%d %b %Y")}</div>
    </td>
    <td style="width:34%;text-align:center;border-top:2px solid {colors['teal']};padding-top:10px;">
      <div style="color:{colors['muted']};font-size:11px;font-weight:700;letter-spacing:0;text-transform:uppercase;">Time to first plan</div>
      <div style="color:{colors['navy']};font-size:16px;font-weight:700;line-height:1.25;margin-top:5px;white-space:nowrap;">{milestone_value}</div>
    </td>
    <td style="width:33%;text-align:center;border-top:2px solid {colors['teal']};padding-top:10px;">
      <div style="color:{colors['muted']};font-size:11px;font-weight:700;letter-spacing:0;text-transform:uppercase;">First plan processed</div>
      <div style="color:{colors['navy']};font-size:16px;font-weight:700;line-height:1.25;margin-top:5px;white-space:nowrap;">{first_plan_milestone}</div>
    </td>
    </tr></table>'''
