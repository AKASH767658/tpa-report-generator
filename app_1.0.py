...
def apply_trend_chart_styling(fig, freq_label, go_live_date=None, y_max=None):
    ...
    if go_live_date is not None:
        fig.add_vline(
            x=pd.Timestamp(go_live_date), line_dash="dash", line_color="#FF7D59",
...
def build_downloadable_report(customer, go_live_date, first_plan, plans, figures, branding):
    ...
    for figure in figures:
        ...
        try:
            ...
            pass  # kaleido isn't installed — the PDF is generated without this chart image.
...
with report_tab:
    ...
    if report:
        ...
        st.download_button(
            ...
            help="Downloads a branded PDF report matching the dashboard's colors.",
        )